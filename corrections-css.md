...
* `<ul>` → uniquement des `<li>`
* `<p>` hors des listes

💡 *Un HTML valide facilite le ciblage CSS.*

> *CSS et HTML travaillent ensemble.*

---

### 4️⃣ Footer : balise `<p>` mal fermée ❌
...
❌ HTML invalide → impact possible sur le rendu
